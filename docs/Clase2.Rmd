...
*Adquiero el curso completo, clases en vivo y materiales por 50 USD:*

[PayPal](https://www.paypal.com/paypalme/hnbiologyinv) 

Enviar comprobandte de pago: 
...
bird <- read.csv(here("docs/data", "bird.sta.csv"))
